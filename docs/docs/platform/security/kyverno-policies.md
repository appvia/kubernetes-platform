...
- **deny-default-namespace** (Validation)
...
Used to deny the use of EKS resources that are not allowed in the cluster. These resources can only be provisioned in the ack-system namespace.

**Rules**

- **deny-eks-resources** (Validation)
...
- **deny-empty-ingress-host** (Validation)
