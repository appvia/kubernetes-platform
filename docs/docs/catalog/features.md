...
| tailscale-operator | tailscale | `enable_tailscale_operator` | Provides the tailscale operator | [docs](https://tailscale.com/docs/features/kubernetes-operator) | `addons/helm/oss.yaml` |
